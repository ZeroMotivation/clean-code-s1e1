...
let createNewTaskElement=function(taskString){
    ...
    //button.edit
    let editButton=document.createElement("edit-button");//edit button

    //button.delete
    let deleteButton=document.createElement("delete-button");//delete button
    let deleteButtonImg=document.createElement("delete-icon");//delete button image
